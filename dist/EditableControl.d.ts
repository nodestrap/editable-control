...
export declare const isValided: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isValidating: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isUnvalidating: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isUnvalided: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isValid: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isUnvalid: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isInvalided: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isInvalidating: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isUninvalidating: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isUninvalided: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isInvalid: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isUninvalid: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
export declare const isNoValidation: (styles: StyleCollection) => import("@cssfn/cssfn").RuleEntry;
/**
 ...
 */
export declare const usesValidInvalidState: () => readonly [() => StyleCollection, import("@cssfn/css-var").ReadonlyRefs<ValidInvalidVars>, import("@cssfn/css-var").ReadonlyDecls<ValidInvalidVars>];
export declare const markValid: () => StyleCollection;
/**
 ...
 */
export declare const usesThemeValid: (themeName?: ThemeName) => StyleCollection;
export declare const markInvalid: () => StyleCollection;
/**
 ...
 */
export declare const usesThemeInvalid: (themeName?: ThemeName) => StyleCollection;
